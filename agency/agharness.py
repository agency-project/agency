...
def get_or_create_host_manager(ag: "agent", agconfig=None):
    ...
    if existing is not None:
        return existing
    from .agharness_internal.agmanager_host import agHostAgentManager
...
def ensure_harness_bridge(sandbox, host_manager) -> str:
    ...
    - Bare-host/chroot (`sandbox` not container-backed, including
      ...
      bridge."""
    from .agharness_internal.agmanager_harness import ensure_launched, ensure_launched_locally
