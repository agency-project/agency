"""Optional bridge client for the standalone tandem harness.

When tandem_harness is launched BY agency, it's given a `--bridge-base-url`
...
When tandem_harness is run fully standalone (no `--bridge-base-url`), this
