"""Unit tests for agency.sandbox.container's shared, runtime-
...
class TestReapOrphanedContainers:
    ...
    def test_removes_container_owned_by_dead_pid(self):
        ...
        with patch("agency.sandbox.container.get_container_runtime", return_value="docker"):
...
class TestRun:
    ...
    run_with_unkillable_child_grace()'s docstring in sandbox/base.py).
