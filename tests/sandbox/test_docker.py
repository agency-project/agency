...
(agency.sandbox.docker._DockerBackend): dangling-image cleanup on
...
_ContainerBackendBase itself (agency.sandbox.container) -- see
...
class TestCheckpointSquash:
    ...
    def test_squash_pipes_export_stdout_into_import_stdin(self):
        ...
        import agency.sandbox.docker as _mod
        from agency.sandbox.container import _AGENCY_OWNER_PID_LABEL
    ...
    def test_second_squash_after_fallback_uses_fast_path(self, tmp_path):
        ...
        unusually large per-commit diffs (see docs/sandbox/
...
class TestLocateLayerDiffDir:
    ...
    def test_chain_id_matches_containerd_definition(self):
        from agency.sandbox.docker import _chain_id_for_diff_ids
        import hashlib
    ...
    def test_parse_ctr_mounts_top_fs(self):
        from agency.sandbox.docker import _parse_ctr_mounts_top_fs
        from pathlib import Path
...
class TestHostToContainerId:
    ...
    def test_translate_id_leaves_unmapped_host_id_unchanged(self):
        from agency.sandbox.docker import _translate_id
...
class TestCheckpointAccumulator:
    ...
    def test_accumulator_squash_uses_squash_base_diff_ids_when_already_set(self, tmp_path):
        ...
        again."""
        import agency.sandbox.docker as _mod
        from agency.sandbox._layer_squash import overlay_diff_to_tar
...
# _ContainerBackendBase (agency.sandbox.container) since docker and
