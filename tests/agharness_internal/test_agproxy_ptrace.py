...
def test_process_lifecycle_profiler_uses_safe_exec_name_and_exit_status(monkeypatch):
    ...
    from agency.agharness_internal import agproxy_ptrace as ptrace_module
    from agency.agharness_internal.agproxy_ptrace_internal._tracer_loop import (
        SeccompStop,
    )
...
def test_executable_display_name_sanitizes_confirmed_exec_path(exec_path, display_name):
    from agency.agharness_internal.agproxy_ptrace import _executable_display_name
...
def test_container_lifecycle_timing_discloses_relay_boundary_jitter(monkeypatch):
    ...
    from agency.agharness_internal import agproxy_ptrace as ptrace_module
    from agency.agharness_internal.agproxy_ptrace_internal import _in_container_launcher
    from agency.profiler import agprof
...
def test_handle_on_exit_can_include_ptrace_exit_status():
    from agency.agharness_internal.agproxy_ptrace import agProxyPtraceHandle
...
def test_clone_threads_do_not_reach_process_lifecycle_callbacks(monkeypatch):
    from agency.agharness_internal.agproxy_ptrace_internal import _tracer_loop
...
def test_in_container_clone_threads_do_not_reach_lifecycle_protocol(monkeypatch):
    from agency.agharness_internal.agproxy_ptrace_internal import _in_container_entrypoint
