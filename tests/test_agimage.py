...
# ---------------------------------------------------------------------------
# agskill.build_prompt_payload — plain vs multimodal
# ---------------------------------------------------------------------------


def test_build_prompt_payload_no_images_returns_plain_string():
...
def test_build_prompt_payload_no_schema_returns_plain_string():
    sk = agskill("t", "")
    inp = agdata(question="hello")
    content = sk.build_prompt_payload(inp)
    assert isinstance(content, str)
...
def test_build_prompt_payload_single_image_returns_array():
...
def test_build_prompt_payload_image_url_correct():
...
def test_build_prompt_payload_image_field_replaced_with_placeholder():
    sk = agskill("t", "", input_schema=agdata(question=str, photo=agimage))
...
def test_build_prompt_payload_list_images_all_injected():
...
def test_build_prompt_payload_list_images_placeholder_shows_count():
    sk = agskill("t", "", input_schema=agdata(frames=list[agimage]))
...
def test_build_prompt_payload_mixed_fields_non_image_preserved():
